...
results = readresults("results_celerite_DRWCelerite.json")
...
writedlm("median_time_DRWC.txt", ArrMediansTime)
writedlm("median_memory_DRWC.txt", ArrMediansMemory)
...
fig[2, 1:2] = Legend(fig[1, 1],
    ax,
    "Number of DRWCelerite components",
    ...
    framevisible=false)
fig
save("Likelihood_benchmarks_DRWC.pdf", fig, px_per_unit=0.5)
save("Likelihood_benchmarks_DRWC.png", fig)
