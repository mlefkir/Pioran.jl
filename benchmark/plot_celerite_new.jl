...
results = readresults("results_celerite_new.json")
...
fig
save("Likelihood_benchmarks_celerite_new.pdf", fig, px_per_unit = 0.5)
save("Likelihood_benchmarks_celerite_new.png", fig)
