...
𝓓 = DoubleBendingPowerLaw(0.4,1e-2,1.5,97.3,3.1)
...
p = plot(p1,p2,layout=(1,2),size=(800,300),ylims=(1e-10,.1),framestyle = :box,legend_foreground_color=:white,grid=:off, minorticks=10,link=:y,dpi=300,left_margin=[5Plots.mm -3Plots.mm],bottom_margin=5Plots.mm)
